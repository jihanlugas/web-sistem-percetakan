...
import { UpdateDesign } from "@/types/design";
...
const defaultInitFormikValue: UpdateDesign = {
  name: '',
  description: '',
  qty: '',
  price: '',
...
const ModalEditDesign: NextPage<Props> = ({ show, onClickOverlay, id }) => {

  const [selectedId, setSelectedId] = useState<string>('')

  const [initFormikValue, setInitFormikValue] = useState<UpdateDesign>(defaultInitFormikValue)
  ...
  const handleSubmit = async (values: UpdateDesign, formikHelpers: FormikHelpers<UpdateDesign>) => {
